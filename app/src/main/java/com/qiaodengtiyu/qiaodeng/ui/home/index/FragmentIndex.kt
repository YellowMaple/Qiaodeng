...
import com.anshdeep.qiaodeng.databinding.FragmentIndexBinding
import com.anshdeep.qiaodeng.databinding.FragmentIndexItemBinding
...
class FragmentIndex : Fragment() {
     ...
     * do in this Fragment.
     */
    private val viewModel: FragmentIndexViewModel by lazy {
        val activity = requireNotNull(this.activity) {
            "You can only access the viewModel after onActivityCreated()"
        }
        ViewModelProviders.of(this, FragmentIndexViewModel.Factory(activity.application))
                .get(FragmentIndexViewModel::class.java)
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val binding: FragmentIndexBinding = DataBindingUtil.inflate(
                inflater,
    ...
    private val Video.launchUri: Uri
        get() {
            val httpUri = android.net.Uri.parse(url)
...
class DevByteAdapter(val callback: VideoClick) : RecyclerView.Adapter<DevByteViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DevByteViewHolder {
        val withDataBinding: FragmentIndexItemBinding = DataBindingUtil.inflate(
 ...
 */
class DevByteViewHolder(val viewDataBinding: FragmentIndexItemBinding) :
        RecyclerView.ViewHolder(viewDataBinding.root) {
    companion object {
        @LayoutRes
        val LAYOUT = R.layout.fragment_index_item
    }
}
